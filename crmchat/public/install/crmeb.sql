...
CREATE TABLE IF NOT EXISTS `eb_tenant_plan_order` (
  ...
  `pay_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1=后台开通,2=线下转账,3=在线支付',
  ...
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
  `pay_no` varchar(32) NOT NULL DEFAULT '' COMMENT '关联支付单号，在线支付开通时写入',
  PRIMARY KEY (`id`),
...
('20260913_01','payment_order',UNIX_TIMESTAMP());
