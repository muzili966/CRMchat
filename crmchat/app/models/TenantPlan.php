...
class TenantPlan extends BaseModel
{
     ...
     * 功能开关字段清单
     */
    const FEATURE_FIELDS = ['auto_reply', 'brand_custom', 'data_export', 'app_push'];

    /**
     * 配额字段清单
     */
    const QUOTA_FIELDS = ['app_limit', 'seat_limit', 'daily_msg_limit', 'storage_limit_mb', 'record_keep_days'];
